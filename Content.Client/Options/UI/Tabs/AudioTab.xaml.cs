...
namespace Content.Client.Options.UI.Tabs
{
    ...
    public sealed partial class AudioTab : Control
    {
        ...
        private void OnApplyButtonPressed(BaseButton.ButtonEventArgs args)
        {
            ...
            _cfg.SetCVar(CCVars.EmotesVolume, EmotesVolumeSlider.Value / 100f * ContentAudioSystem.EmotesMultiplier);
        ...
        private void Reset()
        {
            ...
            EmotesVolumeSlider.Value = _cfg.GetCVar(CCVars.EmotesVolume) * 100f / ContentAudioSystem.EmotesMultiplier;
        ...
        private void UpdateChanges()
        {
            ...
            var isEmotesVolumeSame =
                Math.Abs(EmotesVolumeSlider.Value - _cfg.GetCVar(CCVars.EmotesVolume) * 100f / ContentAudioSystem.EmotesMultiplier) < 0.01f;
            ...
            var isEverythingSame = isMasterVolumeSame && isMidiVolumeSame && isAmbientVolumeSame
                ...
                && isInterfaceVolumeSame && isAnnouncerVolumeSame && isEmotesVolumeSame;
            ...
            EmotesVolumeLabel.Text =
                Loc.GetString("ui-options-volume-percent", ("volume", EmotesVolumeSlider.Value / 100));
            AmbienceSoundsLabel.Text = ((int)AmbienceSoundsSlider.Value).ToString();

            _entityManager.EntityNetManager.SendSystemNetworkMessage(new EmotesVolumeChanged(EmotesVolumeSlider.Value));
        }
    }
}
