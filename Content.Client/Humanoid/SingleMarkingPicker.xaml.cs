...
public sealed partial class SingleMarkingPicker : BoxContainer
{
    ...
    private Sex? _sex; // DEN fix - filter out markings by sex
    ...
    public void UpdateData(List<Marking> markings, string species, Sex sex, int totalPoints)
    {
        _markings = markings;
        _species = species;
        _sex = sex;
        ...
        // DEN fix - filter by sex
        _markingPrototypeCache = _markingManager.MarkingsByCategoryAndSpeciesAndSex(Category, _species, _sex.Value);
    ...
    public void PopulateList(string filter)
    {
        ...
        if (_sex == null)
            throw new ArgumentException("Tried to populate marking list without a provided sex!");
