...
public sealed partial class CharacterRecordViewer : FancyWindow
{
    ...
    //imp/den edit - needed for the job icons
    ...
    public CharacterRecordViewer()
    {
        ...
        IoCManager.InjectDependencies(this); //imp/den edit - needed for job icons

        _spriteSystem = _entitySystem.GetEntitySystem<SpriteSystem>(); //imp/den edit - needed for job icons
    ...
    public void UpdateState(CharacterRecordConsoleState state)
    {
        ...
        RecordContainerJobIcon.Texture =
    ...
    private void UpdateRecordBoxEmployment(FullCharacterRecords record)
    {
        ...
        RecordContainerWorkAuth.Text = record.PRecords.HasWorkAuthorization ? "Approved" : "Denied"; //Den edit wording change
    }
