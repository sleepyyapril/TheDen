...
public sealed class CharacterRequirementsSystem : EntitySystem
{
    ...
    public bool CheckRequirementValid(CharacterRequirement requirement, JobPrototype job,
        HumanoidCharacterProfile profile, List<string> roleBans, Dictionary<string, TimeSpan> playTimes,
        ...
        out string? reason, int depth = 0)
    {
        ...
        return
            !requirement.IsValid(job, profile, roleBans, playTimes, whitelisted, prototype,
    ...
    /// <param name="roleBans">The list of roles this user is banned from.</param>
        ...
        bool whitelisted = false)
    {
        ...
        return CheckRequirementsValid(requirements, jobPrototype, stationSpawningProfile, roleBans, trackerTimes, whitelisted, prototype, _entManager, _protomanager, _configurationManager, out reasons, depth, mind);
    }
        ...
        out List<string> reasons, int depth = 0, MindComponent? mind = null)
    {
        ...
        foreach (var requirement in requirements)
        {
            ...
            if (!requirement.IsValid(job, profile, roleBans, playTimes,whitelisted, prototype,
                entityManager, prototypeManager, configManager,
