...
chat-manager-entity-say-wrap-free-message = [BubbleHeader][Name][font size=11][color={$color}][bold]{$language}[/bold][/color][/font][bold]{$entityName}[/bold][/Name][/BubbleHeader] [BubbleContent]{$message}[/BubbleContent]
...
chat-manager-entity-whisper-free-wrap-message = [BubbleHeader][Name][font size=10][color={$color}][bold]{$language}[/bold][/color][/font][font size=11][italic]{$entityName}[/Name][/BubbleHeader] [BubbleContent]{$message}[/BubbleContent][/italic][/font]
chat-manager-entity-whisper-unknown-free-wrap-message = [BubbleHeader][font size=10][color={$color}][bold]{$language}[/bold][/color][/font][font size=11][italic]Someone[/BubbleHeader] [BubbleContent]{$message}[/BubbleContent][/italic][/font]
