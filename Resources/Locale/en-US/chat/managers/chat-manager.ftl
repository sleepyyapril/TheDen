...
chat-manager-entity-say-wrap-free-message = [font size=11][color={$color}][bold]{$language}[/bold][/color][/font][bold]{$entityName}[/bold]{$space}[BubbleContent]{$message}[/BubbleContent]
...
chat-manager-entity-whisper-free-wrap-message = [font size=10][color={$color}][bold]{$language}[/bold][/color][/font][font size=11][italic]{$entityName}{$space}[BubbleContent]{$message}[/BubbleContent][/italic][/font]
chat-manager-entity-whisper-unknown-free-wrap-message = [font size=10][color={$color}][bold]{$language}[/bold][/color][/font][font size=11][italic][BubbleHeader]Someone[/BubbleHeader]{$space}[BubbleContent]{$message}[/BubbleContent][/italic][/font]
