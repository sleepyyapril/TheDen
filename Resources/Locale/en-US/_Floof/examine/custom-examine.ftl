...
custom-examine-nsfw-hidden = [color=#9999a9]<More is hidden due to consent preferences>[/color]
custom-examine-create = Create New
custom-examine-edit = Edit
custom-examine-editing = Editing {$entry}
custom-examine-delete = Delete