...
trait-name-TraitorNonTargetable = Marked as Protected
trait-description-TraitorNonTargetable = Someone or something wants to keep you alive. Traitors cannot receive any orders to kill you or teach you a lesson.
