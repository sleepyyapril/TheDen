...
thaven-mood-hug-good-desc = It is extremely impolite not to hug people frequently, but you should ask first.
...
thaven-mood-voxsymp-name = Sympathizer
thaven-mood-voxsymp-desc = To demonstrate your allyship with vox and plasmamen, you must be wearing internals at all times.
