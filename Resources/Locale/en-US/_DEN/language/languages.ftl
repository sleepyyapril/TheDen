...
# SPDX-FileCopyrightText: 2026 Fox" Miakova
#
...
language-Alaseta-description =  A language based on a mix of Canilunzt and Terran Chinese, Alaseta is hard to understand at first, but a careful ear can soon adapt.
