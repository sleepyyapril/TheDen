# AI Customizations - put all ports / den-custom ones here. If you are ever going to consider porting to wizden, merge with the upstream file.
...
station-ai-icon-lamp = Moth
station-ai-icon-liz = Lizard
station-ai-icon-matrix = Falling green text
station-ai-icon-nanotrasen = Nanotrasen logo
station-ai-icon-triumvirate = Triumvirate
station-ai-icon-vox = Vox

station-ai-hologram-angel = Angel appearance
station-ai-hologram-male = Bird appearance
station-ai-hologram-face = Cloud Cat form
station-ai-hologram-cat = Frost Phoenix form
