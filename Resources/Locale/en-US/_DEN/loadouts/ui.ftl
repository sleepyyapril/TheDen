...
loadout-item-list-panel-clear-search = Clear
loadout-item-button-customize-button = Customize
loadout-item-button-guidebook-tooltip = This button will direct you to the guidebook entry on this item.
