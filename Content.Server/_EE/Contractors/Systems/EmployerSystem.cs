...
public sealed class EmployerSystem : EntitySystem
{
    ...
    private void OnPlayerSpawnComplete(PlayerSpawnCompleteEvent args)
    {
        ...
        ApplyEmployer(args.Mob, args.JobId, args.Profile, roleBans, playTime, whitelisted);
    }
    ...
    public void ApplyEmployer(EntityUid uid, ProtoId<JobPrototype>? jobId, HumanoidCharacterProfile profile,
        List<string> roleBans, Dictionary<string, TimeSpan> playTimes, bool whitelisted)
    {
